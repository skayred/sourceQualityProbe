var configUtil = require('./node_modules/nyc/lib/config-util')
var foreground = require('foreground-child')
var NYC
try {
  NYC = require('./node_modules/nyc/index.covered.js')
} catch (e) {
  NYC = require('./node_modules/nyc/index.js')
}
var processArgs = require('./node_modules/nyc/lib/process-args')

var sw = require('spawn-wrap')
var wrapper = require.resolve('./node_modules/nyc/bin/wrap.js')
